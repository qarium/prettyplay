...
class TestComplianceFindingContract:
    ...
    def test_declares_exactly_three_fields_with_empty_defaults(self) -> None:
        assert set(ComplianceFinding.model_fields) == {"instruction", "priority", "explanation"}
...
class TestParseComplianceVerdict:
    ...
    def test_parse_compliance_verdict_tolerates_extra_keys_and_padding(self) -> None:
        verdict = '  [ {"instruction": "i", "priority": "medium", "explanation": "e", "note": "chatty"} ]  '
    ...
    def test_parse_compliance_verdict_tolerates_empty_string_field_values(self) -> None:
        verdict = '[{"instruction": "", "priority": "high", "explanation": ""}]'
